...
class LexiconEncoder(nn.Module):
    ...
    def forward(self, batch_list, name_map):
        ...
        doc_tok = self.patch(batch_list[name_map['doc_tok']])
        doc_mask = self.patch(batch_list[name_map['doc_mask']])
        query_tok = self.patch(batch_list[name_map['query_tok']])
        query_mask = self.patch(batch_list[name_map['query_mask']])
